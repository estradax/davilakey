    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 pt-5">
                ...
                <ul class="list-unstyled text-light footer-link-list">
                    <li><a class="text-decoration-none" href="{{ route('shop') }}">Buy</a></li>
                    <li><a class="text-decoration-none" href="{{ route('shop', ['cat' => '1']) }}">Rent</a></li>
                </ul>
            </div>
            ...
            <div class="row pt-2">
                <div class="col-12">
                    <p class="text-left text-light">
                        Copyright &copy; {{ \Carbon\Carbon::now()->format('Y') }} {{ config('app.name') }}
                    </p>
                </div>
            </div>
        </div>
