    ...
    <div class="max-w-screen-xl mx-auto p-4 flex items-start">
        <div class="w-64 mr-4 bg-gray-900 text-white p-4 rounded-lg border border-gray-700 shadow">
            <div class="flex justify-center">
                <img class="rounded-full w-48 h-48" src="https://images.unsplash.com/photo-1541643600914-78b084683601?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=704&q=80" alt="Apple Watch">
            </div>
            ...
            <form>
                <div class="space-y-12">
                    <div class="border-b border-gray-900/10">
                        <h2 class="text-base font-semibold leading-7">Product #SDSJK32</h2>
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div class="sm:col-span-4">
                                ...
                                <div class="mt-2">
                                    <div class="flex rounded-md shadow-sm focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                        <input type="text" name="username" id="username" autocomplete="username" class="block flex-1 border border-gray-600 rounded-lg bg-gray-700 py-1.5 focus:ring-0 sm:text-sm" value="Iphone 12">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-4">
                                ...
                                <div class="mt-2">
                                    <div class="flex rounded-md shadow-sm focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                        <input type="text" name="username" id="username" autocomplete="username" class="block flex-1 border border-gray-600 rounded-lg bg-gray-700 py-1.5 focus:ring-0 sm:text-sm" value="899">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-span-full">
                                ...
                                <div class="mt-2">
                                    <textarea id="about" name="about" rows="3" class="block w-full rounded-md border-0 py-1.5 border border-gray-600 rounded-lg bg-gray-700 shadow-sm focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">Ayoo bermain bersama ku</textarea>
                                </div>
