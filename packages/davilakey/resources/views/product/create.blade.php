    ...
    <div class="max-w-screen-xl mx-auto p-4 flex items-start">
        <div class="w-64 mr-4 bg-gray-900 text-white p-4 rounded-lg border border-gray-700 shadow">
            ...
            <div class="mt-4 flex justify-center">
                <label class="text-sm font-semibold leading-6 text-indigo-500 cursor-pointer">
                    <input class="hidden" type="file" name="photo">
                    Change
                </label>
            </div>
        </div>
                    ...
                    <div class="border-b border-gray-900/10">
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div class="sm:col-span-4">
                                ...
                                <div class="mt-2">
                                    <div class="flex rounded-md shadow-sm focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                        <input type="text" name="name" id="username" autocomplete="username" class="block flex-1 border border-gray-600 rounded-lg bg-gray-700 py-1.5 focus:ring-0 sm:text-sm" placeholder="Name of the product">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-4">
                                ...
                                <div class="mt-2">
                                    <div class="flex rounded-md shadow-sm focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                                        <input type="text" name="price" id="username" autocomplete="username" class="block flex-1 border border-gray-600 rounded-lg bg-gray-700 py-1.5 focus:ring-0 sm:text-sm" placeholder="Price of the product">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-span-full">
                                ...
                                <div class="mt-2">
                                    <textarea id="about" name="description" rows="3" class="block w-full rounded-md border-0 py-1.5 border border-gray-600 rounded-lg bg-gray-700 shadow-sm focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Description of the product"></textarea>
                                </div>
